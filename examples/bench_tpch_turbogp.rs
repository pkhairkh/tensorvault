...
/// Q4 (EXISTS) and Q20 (IN-subquery) are now handled via decorrelation.
/// Q19 (OR of join conditions) and Q21 (double EXISTS with multi-column
/// correlation) still unsupported.
const SKIP_QUERIES: &[&str] = &["Q19", "Q21"];
