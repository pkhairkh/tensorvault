...
/// Q4 (EXISTS) is now handled via semi-join decorrelation.
/// Q19 (OR of join conditions), Q20 (nested IN-subqueries), and
/// Q21 (double EXISTS with multi-column correlation) still unsupported.
const SKIP_QUERIES: &[&str] = &["Q19", "Q20", "Q21"];
