...
/// Q4 (EXISTS) and Q19 (OR of join conditions) are now handled.
/// Q20 (nested IN-subqueries, times out) and Q21 (double EXISTS with
/// multi-column correlation) still unsupported.
const SKIP_QUERIES: &[&str] = &["Q20", "Q21"];
